...
void HAL_PCD_MspInit(PCD_HandleTypeDef* pcdHandle)
{
  ...
  /* USER CODE END USB_OTG_FS_MspInit 0 */
    ...
    PA11     ------> USB_OTG_FS_DM
    PA12     ------> USB_OTG_FS_DP
    (PA9 VBUS sensing disabled — self-made PCB without VBUS on PA9)
    */
    /* PA9 VBUS sensing GPIO removed — vbus_sensing_enable = DISABLE */
...
void HAL_PCD_MspDeInit(PCD_HandleTypeDef* pcdHandle)
{
  ...
  /* USER CODE END USB_OTG_FS_MspDeInit 0 */
    ...
    PA12     ------> USB_OTG_FS_DP
    */
    HAL_GPIO_DeInit(GPIOA, GPIO_PIN_11|GPIO_PIN_12);  /* PA9 not used (VBUS sensing disabled) */
...
USBD_StatusTypeDef USBD_LL_Init(USBD_HandleTypeDef *pdev)
{
  ...
  hpcd_USB_OTG_FS.Init.vbus_sensing_enable = DISABLE;  /* 自製 PCB：PA9 未接 USB VBUS，停用感測 */
