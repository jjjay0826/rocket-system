...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LED_B10_Pin|SIG_3_Pin|GPIO_PIN_8, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LED_B2_Pin LED_B10_Pin BARO_CS_Pin SIG_3_Pin
                           PB8 */
  GPIO_InitStruct.Pin = LED_B2_Pin|LED_B10_Pin|BARO_CS_Pin|SIG_3_Pin
                          |GPIO_PIN_8;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : SIG_2_Pin SIG_1_Pin */
  GPIO_InitStruct.Pin = SIG_2_Pin|SIG_1_Pin;
