...
/* Private defines -----------------------------------------------------------*/
#define FIRE_7V_1_Pin GPIO_PIN_0
#define FIRE_7V_1_GPIO_Port GPIOA
#define FIRE_7V_2_Pin GPIO_PIN_1
#define FIRE_7V_2_GPIO_Port GPIOA
...
#define SEN_MISO_Pin GPIO_PIN_14
#define SEN_MISO_GPIO_Port GPIOB
#define SEN_MOSI_Pin GPIO_PIN_15
#define SEN_MOSI_GPIO_Port GPIOB
#define IMU_CS_N_Pin GPIO_PIN_8
#define IMU_CS_N_GPIO_Port GPIOA
